...
<div class="float-md-start" style="max-width: 310px; border:transparent; margin-top:3%;"> 
  <div class="card border-secondary mb-3">
      ...
      <div class="card-footer bg-transparent border-transparent" align="center">
        {{-- Informar número do whatss app --}}
        <a href="https://api.whatsapp.com/send?phone=5541997518499&amp;text=Olá gostaria de uma informação sobre o {{ $product->id . ' - ' . $product->name }}" target="_blank" rel="noopener noreferrer"><img src="{{URL::asset('/imgs/whatts2.png')}}" alt="contatowhats" class="whatsapp"></a>
